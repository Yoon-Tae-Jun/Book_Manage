...
public class Usersql {
	...
	public static final String GET_BORROWED_LIST = "select * from book where borrowedUser = #{userID}";
	public static final String GET_RESERVED_LIST = "select * from book where reservedUser = #{userID}";
	...
	public static final String EMAIL_CHECK = "select COUNT(*) from user where userEmail = #{email}";
}
